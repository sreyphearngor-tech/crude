        ...
        <nav class="container mx-auto px-4 md:px-12 lg:px-24 flex items-center justify-between py-4">
            ...
            <a href="<?php echo e(route('home')); ?>" class="flex items-center">
                <div class="w-[60px] h-[60px] md:w-[80px] md:h-[80px]">
                    <img src="<?php echo e(asset('images/logo.jpg')); ?>" alt="Logo" class="h-full w-auto object-contain"
            ...
            <ul class="hidden md:flex items-center gap-8 font-medium">
                <li><a href="<?php echo e(route('home')); ?>"
                        class="<?php echo e(request()->routeIs('home') ? 'border-b-2 border-red-500' : ''); ?> hover:text-red-500 pb-1">Home</a>
                </li>
                <li><a href="#"
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="<?php echo e(route('cart.index')); ?>" class="hover:text-red-500 relative inline-block transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2 text-gray-400 text-sm">
                        ...
                        <li><a href="<?php echo e(route('cart.index')); ?>" class="hover:text-white transition">Cart</a></li>
                        <li><a href="#" class="hover:text-white transition">Wishlist</a></li>
                        <li><a href="<?php echo e(route('home')); ?>" class="hover:text-white transition">Shop</a></li>
                    </ul>
                </div>
        ...
        $(document).ready(function() {
            ...
            <?php if(session('checkout_success')): ?>
                Swal.fire({
                    ...
                    text: "<?php echo e(session('checkout_success')); ?>",
                    icon: 'success',
...
<?php /**PATH D:\wamp64\www\migrate\crude\resources\views/layouts/app.blade.php ENDPATH**/ ?>