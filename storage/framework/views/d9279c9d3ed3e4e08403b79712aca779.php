...
<?php $component->withAttributes([]); ?>
    ...
    <div class="dash-wrap">
        ...
        <aside class="sidebar" id="mainSidebar">
            ...
            <div class="sidebar-section">
                ...
                <a href="<?php echo e(route('admin.product.index')); ?>" id="productLink"
            ...
            <div class="sidebar-section">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" id="productLink"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="description" rows="6" placeholder="Write something about this product..."
                                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white outline-none transition"><?php echo e(old('description')); ?></textarea>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <label
                                                ...
                                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                    ...
                                                    <p
                                                        ...
                                                        Image <?php echo e($i); ?> <?php echo e($i == 1 ? '(Main)' : ''); ?></p>
                                                </div>
                                                <input type="file" name="image<?php echo e($i == 1 ? '' : $i); ?>"
    ...
    <script>
        ...
        document.getElementById('ajaxCategoryForm').addEventListener('submit', function(e) {
            ...
            fetch("<?php echo e(route('admin.categories.index')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\migrate\crude\resources\views/admin/product/create.blade.php ENDPATH**/ ?>