    ...
    <div
        ...
        <div>
            ...
            <div class="flex items-center justify-between mb-8">
                <a href="<?php echo e(route('cart.index')); ?>" class="text-gray-800 hover:text-black">
            ...
            <!-- Form Details -->
            <form id="shipping-form" action="<?php echo e(route('checkout.shipping.save')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\migrate\crude\resources\views/checkout/shipping.blade.php ENDPATH**/ ?>