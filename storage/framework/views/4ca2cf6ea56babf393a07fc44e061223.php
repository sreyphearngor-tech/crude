        ...
        <aside class="sidebar" id="mainSidebar">
            ...
            <div class="sidebar-section">
                ...
                <a href="<?php echo e(route('admin.product.index')); ?>"
                    class="sidebar-link sidebar-prod-toggle <?php echo e(request()->routeIs('admin.product.*') ? 'active' : ''); ?>">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="sidebar-section">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.categories.index') ? 'active' : ''); ?>">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="content">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($outOfStock ?? 0); ?></div>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\migrate\crude\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>