    ...
    <div
        ...
        <div>
            ...
            <div class="flex items-center justify-between mb-8">
                <a href="{{ route('checkout.shipping') }}" class="text-gray-800 hover:text-black">
            ...
            <!-- Payment Form -->
            <form id="payment-form" action="{{ route('checkout.payment.save') }}" method="POST" class="space-y-6">
                @csrf
