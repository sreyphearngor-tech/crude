    ...
    <div class="container mx-auto px-4 md:px-12 lg:px-24">
        ...
        <div class="flex flex-col md:flex-row gap-8 py-10">
            ...
            <div
                ...
                <img src="{{ asset('images/watch3.jpg') }}" alt="Promo"
        ...
        @if (request('query'))
            <div class="mb-10">
                <h2 class="text-2xl font-bold">Search Results for: <span
                        class="text-red-500">"{{ request('query') }}"</span></h2>
                        ...
                        <div class="group">
                            <div
                                ...
                                @if (isset($product->discount))
                                    <span
                                        class="absolute top-3 left-3 bg-red-500 text-white text-xs px-3 py-1 rounded">-{{ $product->discount }}%</span>
                                @endif
                                ...
                                <div class="absolute top-3 right-3 flex flex-col gap-2 z-20">
                                    ...
                                    <a href="{{ route('product.show_detail', $product->id) }}"
                            ...
                            <div class="mt-4 space-y-2">
                                ...
                                <div class="flex gap-3 font-medium">
                                    ...
                                    @if (isset($product->old_price))
                                        <span
                                            class="text-gray-400 line-through">${{ number_format($product->old_price, 2) }}</span>
                                    @endif
                                </div>
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-gray-400 text-sm font-bold">({{ $product->reviews_count ?? 0 }})</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="group">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex gap-3 items-center">
                                    ...
                                    @if (isset($product->old_price))
                                        <span
                                            class="text-gray-400 line-through text-sm">${{ number_format($product->old_price, 2) }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <section class="mb-20">
            <div class="w-full h-[500px] md:h-[400px] mt-10 overflow-hidden rounded-md relative bg-gray-200">
                <img src="{{ asset('images/banner1.jpg.png') }}" alt="Promo Banner"
